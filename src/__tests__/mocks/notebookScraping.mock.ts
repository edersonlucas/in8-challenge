export const returnGetAllNotebooksMethod = [
  {
    id: 545,
  ...
  },
  {
    ...
    description: '13.3" Touch, Core i5-4210U, 8GB, 128GB SSD, Windows 8.1',
    rating: {
      qtyReviews: 4,
      ratingLevel: 3,
    },
...
export const returnGetNotebookDetailByIdMethod = {
